...
if(!empty($_POST)){
  ...
  if(isset($_POST['protoc'])){
    ...
    if($validator->isValid()){
      $db = new Database;
      $validator->isUniq('name',$db,App::getTableRegerProtocols(),"The protocol already exists.");
    }
  ...
  elseif(isset($_POST['catego'])){
    ...
    if($validator->isValid()){
      $db = new Database;
      $validator->isUniq('category',$db,App::getTableRegerProtocolCategories(),"The category already exists.");
    }
    if($validator->isValid()){
      $protocol = new Protocol("reger");
...
echo $form->protocolCategorySelect(App::getTableRegerProtocolCategories(),"category", "Category : ", "Choose a category",'');
