...
if(!empty($_POST)){
  ...
  if($validator->isValid()){
    if(!empty($_FILES['msds']['name'])){
      $up = new Upload('msds','reger','chemical','msds');
      if(!empty($mod->msds)){
        $del = new Upload('msds','reger','chemical','msds');
        $del->delete($mod->msds);
      }
      $msds = $up->upload();
    }
    ...
    if(!empty($_FILES['documentation']['name'])){
      $up = new Upload('documentation','reger','chemical','doc');
      if(!empty($mod->documentation)){
        $del = new Upload('documentation','reger','chemical','doc');
