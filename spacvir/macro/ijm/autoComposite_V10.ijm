...
//Nicolas LANDREIN
//=============== Variables=======================
CoolsnapPixelSize = "6,45um";
HamamatsuOrcaPixelSize = "3,63um";


listeMicroscope = newArray("AxioImager Z1","AxioPlan", "Leica inverted in Harry's P2");
sourceType = newArray("UV Lamp","CoolLED", "Harry's LED");
...
filtersPlan_UV = newArray("FAR RED","RED", "FITC", "DAPI","Phase");
filtersPlan_LED = newArray ("","LED RED","LED FITC","LED DAPI","Phase");
filtersHW = newArray("LED Cy5","LED mCherry","LED GFP","LED Dapi","Phase");
...
Dialog.create("Colours into the composite");
