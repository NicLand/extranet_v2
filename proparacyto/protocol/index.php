...
<h1 class="mt-3">ProParaCyto Protocols</h1>
<?= '<a href="'.App::getRoot().'/proparacyto/protocol/new.php?p=cat" class="btn btn-primary m-2" role="button">Add a new Category</a>';?>
<?= '<a href="'.App::getRoot().'/proparacyto/protocol/new.php?p=pro" class="btn btn-success m-2" role="button">Add a new Protocol</a>';?>
<?php
